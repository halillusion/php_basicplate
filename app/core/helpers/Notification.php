	...
	public static function create (string $type, array $data) {
		...
		switch ($type) {
			...
			case 'recovery_completed':
				...
				$title = lang('notification.recover_completed_title');
				$mailBody = str_replace(['[USER]'], [$data['u_name']], lang('notification.recover_completed_mail_body'));
			...
			case 'verify_email':
				...
				$title = lang('notification.verify_email_title');
				$mailBody = str_replace(['[USER]', '[LINK]'], [$data['u_name'], $link], lang('notification.verify_email_mail_body'));
