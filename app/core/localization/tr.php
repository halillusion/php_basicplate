...
return [
	...
	'page'	=> [
		...
		'pages'								=> 'Sayfalar',
		'pages_desc'						=> 'Sayfa yönetim ekranı.',
		'contents'							=> 'İçerikler',
		'contents_desc'						=> 'İçerik yönetim ekranı.',
		'categories'						=> 'Kategoriler',
		'categories_desc'					=> 'Kategori yönetim ekranı.',
		'media'								=> 'Ortam',
		'media_desc'						=> 'Ortam yönetim ekranı.',
		'contact_forms'						=> 'İletişim Formları',
		'contact_forms_desc'				=> 'İletişim formları yönetim ekranı.',
		'users'								=> 'Kullanıcılar',
		'users_desc'						=> 'Kullanıcı yönetim ekranı.',
		'user_roles'						=> 'Kullanıcı Rolleri',
		'user_roles_desc'					=> 'Kullanıcı rolü yönetim ekranı.',
		'logs'								=> 'Kayıtlar',
		'logs_desc'							=> 'Kayıt listeleme ekranı.',
		'settings'							=> 'Ayarlar',
		'settings_desc'						=> 'Ayar yönetim ekranı.',
	],
